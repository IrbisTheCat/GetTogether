...
/** __static_js_modules__/pageslikefollownotifactions.js */




__d("PagesLikeFollowNotifActions",[],(function a(b,c,d,e,f,g){

f.exports={INIT_DATA:"init_data",LIKE:"like",UNLIKE:"unlike",FOLLOW_CHANGED:"follow_changed",NOTIF_CHANGE:"notif_change",NOTIF_ALL_ON:"notif_all_on",NOTIF_ALL_OFF:"notif_all_off",NEWS_FEED_CHANGE:"news_feed_change"};}),

null);

/** __static_js_modules__/videocreatorproducttype.js */




__d("VideoCreatorProductType",[],(function a(b,c,d,e,f,g){

f.exports={LEGACY:0,UNSPECIFIED:1,CORE_VIDEOS:2,LOOPS:3,ANIMATED_GIFS:4,SLIDESHOW:5,PROFILE_VIDEO:6,SPHERICAL:7,LIVE_PHOTO:8,BIRTHDAY_VIDEO:9,STORYLINE:10,FRIENDS_DAY_2016:11,FRIENDVERSARY:12,STORYLINE_WITH_EXTERNAL_MUSIC:13,GOODWILL_VIDEO_BIRTHDAY:14,GOODWILL_VIDEO_ANNIVERSARY:15,GOODWILL_VIDEO_FACEVERSARY:16,GOODWILL_VIDEO_YIR16:17,GOODWILL_VIDEO_FRIENDSDAY17:18,GOODWILL_VIDEO_FRIEND_BIRTHDAY_VIDEO:19};}),

null);

/** www/__virtual__/x/XAYMTMultiTipAsyncClickController.js */



__d("XAYMTMultiTipAsyncClickController",["XController"],(function a(b,c,d,e,f,g){
f.exports=c("XController").create("\/ads\/growth\/aymt\/multi_async_click\/",{tip_id:{type:"String"},channel_id:{type:"String"},aymt_data:{type:"String"},target:{type:"String",required:true},handled_delete:{type:"Bool",defaultValue:true},extra_data:{type:"String"}});}),

null);

/** www/__virtual__/x/XAYMTMultiTipCarouselNavigationLoggerAsyncController.js */



__d("XAYMTMultiTipCarouselNavigationLoggerAsyncController",["XController"],(function a(b,c,d,e,f,g){
f.exports=c("XController").create("\/ads\/growth\/aymt\/log\/carousel_navigation\/",{tip_id:{type:"String"},channel_id:{type:"String"},aymt_data:{type:"String"},message:{type:"String",required:true}});}),

null);

/** www/__virtual__/x/XAYMTTipImpressionLoggerAsyncController.js */



__d("XAYMTTipImpressionLoggerAsyncController",["XController"],(function a(b,c,d,e,f,g){
f.exports=c("XController").create("\/ads\/growth\/aymt\/log\/impression\/",{tip_id:{type:"String"},channel_id:{type:"String"},aymt_data:{type:"String"},reason:{type:"String"},message:{type:"String"}});}),

null);

/** www/__virtual__/x/XAYMTTipTourCompleteLoggerAsyncController.js */



__d("XAYMTTipTourCompleteLoggerAsyncController",["XController"],(function a(b,c,d,e,f,g){
f.exports=c("XController").create("\/ads\/growth\/aymt\/log\/tour_complete\/",{tip_id:{type:"String"},channel_id:{type:"String"},aymt_data:{type:"String"}});}),

null);

/** www/__virtual__/x/XAdsCMTipQEAsyncController.js */



__d("XAdsCMTipQEAsyncController",["XController"],(function a(b,c,d,e,f,g){
f.exports=c("XController").create("\/ads\/manager\/ajax\/check_tip_qe\/",{tip_id:{type:"String",required:true},channel_id:{type:"String",required:true}});}),

null);

/** js/ads/aymt/AYMTClientSideLogging.js */
...
__d('AYMTClientSideLogging',['AsyncRequest','AYMTTipEventType','AYMTTipSettings','XAYMTTipImpressionLoggerAsyncController','XAYMTMultiTipAsyncClickController','XAYMTMultiTipCarouselNavigationLoggerAsyncController','XAYMTTipTourCompleteLoggerAsyncController','XAdsCMTipQEAsyncController'],(function a(b,c,d,e,f,g){
'use strict';
...
{logEligibilityAndCheckQE:function i
(j,
k,
l,
m){

var n=c('XAdsCMTipQEAsyncController').getURIBuilder().
setString('tip_id',l.data.tip_id).
setString('channel_id',l.data.channel_id).
getURI();
new (c('AsyncRequest'))().
setURI(n).
...
logImpression:function i(j,k){
var l=c('XAYMTTipImpressionLoggerAsyncController').getURIBuilder().
setString('tip_id',j).
setString('channel_id',k).
getURI();
new (c('AsyncRequest'))().
setURI(l).
setAllowCrossPageTransition(true).
...
var l=arguments.length<=2||arguments[2]===undefined?true:arguments[2],
m=c('XAYMTMultiTipAsyncClickController').getURIBuilder().
setString('tip_id',j).
setString('channel_id',k).
setString('target',c('AYMTTipEventType').XOUT).
setBool('handled_delete',l).
getURI();
new (c('AsyncRequest'))().
setURI(m).
setAllowCrossPageTransition(true).
...
logClick:function i(j,k){
var l=c('XAYMTMultiTipAsyncClickController').getURIBuilder().
setString('tip_id',j).
setString('channel_id',k).
setString('target',c('AYMTTipEventType').CLICK).
getURI();
new (c('AsyncRequest'))().
setURI(l).
setAllowCrossPageTransition(true).
...
logTourComplete:function i(j,k){
var l=c('XAYMTTipTourCompleteLoggerAsyncController').getURIBuilder().
setString('tip_id',j).
setString('channel_id',k).
getURI();
new (c('AsyncRequest'))().
...
logTourStepImpression:function i(j,k,l){
var m=c('XAYMTTipImpressionLoggerAsyncController').getURIBuilder().
setString('tip_id',j).
setString('channel_id',k).
setString('reason','tour_step').
setString('message',l.toString()).
getURI();
new (c('AsyncRequest'))().
setURI(m).
setAllowCrossPageTransition(true).
...
logRenderingTypeImpression:function i
(j,
k,
l){
...
setString('tip_id',j).
setString('channel_id',k).
setString('reason','rendering_type').
setString('message',l).
getURI();
new (c('AsyncRequest'))().
setURI(m).
...
logCarouselNavigation:function i(j,k,l){
var m=
c('XAYMTMultiTipCarouselNavigationLoggerAsyncController').getURIBuilder().
setString('tip_id',j).
setString('channel_id',k).
setString('message',l).
getURI();
...
logClickNew:function i(j){
var k=c('XAYMTMultiTipAsyncClickController').getURIBuilder().
setString('tip_id',j[c('AYMTTipSettings').TIP_ID]).
setString('channel_id',j[c('AYMTTipSettings').CHANNEL_ID]).
setString('aymt_data',JSON.stringify(j)).
setString('target',c('AYMTTipEventType').CLICK).
getURI();
new (c('AsyncRequest'))().
setURI(k).
...
logImpressionNew:function i(j){
var k=c('XAYMTTipImpressionLoggerAsyncController').getURIBuilder().
setString('tip_id',j[c('AYMTTipSettings').TIP_ID]).
setString('channel_id',j[c('AYMTTipSettings').CHANNEL_ID]).
setString('aymt_data',JSON.stringify(j)).
getURI();
...
logXoutNew:function i
(j){

var k=arguments.length<=1||arguments[1]===undefined?true:arguments[1],
l=c('XAYMTMultiTipAsyncClickController').getURIBuilder().
setString('tip_id',j[c('AYMTTipSettings').TIP_ID]).
setString('channel_id',j[c('AYMTTipSettings').CHANNEL_ID]).
setString('aymt_data',JSON.stringify(j)).
setString('target',c('AYMTTipEventType').XOUT).
setBool('handled_delete',k).
getURI();
new (c('AsyncRequest'))().
setURI(l).
setAllowCrossPageTransition(true).
...
logTourCompleteNew:function i(j){
var k=c('XAYMTTipTourCompleteLoggerAsyncController').getURIBuilder().
setString('tip_id',j[c('AYMTTipSettings').TIP_ID]).
setString('channel_id',j[c('AYMTTipSettings').CHANNEL_ID]).
setString('aymt_data',JSON.stringify(j)).
getURI();
...
logTourStepImpressionNew:function i(j,k){
var l=c('XAYMTTipImpressionLoggerAsyncController').getURIBuilder().
setString('tip_id',j[c('AYMTTipSettings').TIP_ID]).
setString('channel_id',j[c('AYMTTipSettings').CHANNEL_ID]).
setString('aymt_data',JSON.stringify(j)).
setString('reason','tour_step').
setString('message',k.toString()).
getURI();
new (c('AsyncRequest'))().
setURI(l).
setAllowCrossPageTransition(true).
...
logRenderingTypeImpressionNew:function i
(j,
k){
...
logCarouselNavigationNew:function i(j,k){
var l=
c('XAYMTMultiTipCarouselNavigationLoggerAsyncController').getURIBuilder().
setString('tip_id',j[c('AYMTTipSettings').TIP_ID]).
setString('channel_id',j[c('AYMTTipSettings').CHANNEL_ID]).
...
/** js/components/FileInput/FileInput.react.js */





__d('FileInput.react',['cx','invariant','FileInput','InlineBlock.react','React','ReactDOM','joinClasses'],(function a(b,c,d,e,f,g,h,i){var j,k,
...
return this.$FileInput_fileInput;}.
bind(this),this.

focus=function(){
var s=c('ReactDOM').findDOMNode(this.refs.fileInput);
if(!s.disabled)
s.focus();}.

bind(this),o;}m.prototype.render=function(){'use strict';var n=c('joinClasses')("_m",this.props.containerClassName),o='container',p=c('React').createElement('input',babelHelpers['extends']({},this.props,{type:'file',className:c('joinClasses')(this.props.className,"_n"),ref:'fileInput'}),undefined);if(this.props.display==='inline-block')return c('React').createElement(c('InlineBlock.react'),{className:n,ref:o},this.props.children,p);return c('React').createElement('span',{className:n,ref:o},this.props.children,p);};m.prototype.componentDidMount=function(){'use strict';var n=c('ReactDOM').findDOMNode(this.refs.fileInput),o=c('ReactDOM').findDOMNode(this.refs.container),p=o.firstChild;p.nodeName==='A'||i(0,'The root node of <FileInput>\'s control element must be a link. '+'If you\'re trying to use a <Button>, be sure to add an href.');p.setAttribute('rel','ignore');this.$FileInput_fileInput=new (c('FileInput'))(o,p,n);};m.prototype.componentWillUnmount=function(){'use strict';this.$FileInput_fileInput.destroy();this.$FileInput_fileInput=null;};m.propTypes={containerClassName:l.string,display:l.oneOf(['inline-block','inline'])};m.defaultProps={display:'inline-block'};


f.exports=m;}),null);

/** js/components/LoadingDialog/LoadingDialog.react.js */





__d('LoadingDialog.react',['cx','LoadingDialogDimensions','React','XUICard.react','XUIDialog.react','XUISpinner.react'],(function a(b,c,d,e,f,g,h){
...
function i(j){
var k=j.placeholder,l=babelHelpers.objectWithoutProperties(j,['placeholder']);
k=k||
c('React').createElement('div',{className:"_57-x"},
c('React').createElement(c('XUISpinner.react'),{size:'large',background:'light'}));



return (c('React').createElement(c('XUIDialog.react'),babelHelpers['extends']
({shown:true,
width:c('LoadingDialogDimensions').WIDTH},
l),
c('React').createElement(c('XUICard.react'),null,k)));}
...
/** shared_core/fbjs/crypto/md5.js */
...
/** js/logging/WaterfallIDGenerator.js */




__d('WaterfallIDGenerator',['CurrentUser','md5'],(function a(b,c,d,e,f,g){
...
var j=
{generate:function k(){
return c('md5')([c('CurrentUser').getID(),i(),h()].join(':'));}};



f.exports=j;}),null);

/** js/mercury/clients/chat/ChatTabViewEvents.js */
...
f.exports=new (c('Arbiter'))();}),null);

/** js/sdk/DOMWrapper.js */
...
__d('Flash',['DOMEventListener','DOMWrapper','QueryString','UserAgent_DEPRECATED','guid','htmlSpecialChars'],(function a(b,c,d,e,f,g){
...
var h={},
i,
j=c('DOMWrapper').getWindow().document;

function k(p){
var q=j.getElementById(p);
if(q)
...
return p.replace
(/\d+/g,
function(q){return '000'.substring(q.length)+q;});}
...
c('DOMEventListener').add(window,'unload',l);
...
{embed:function p(q,r,s,t){

var u=c('guid')();



q=c('htmlSpecialChars')(q).replace(/&amp;/g,'&');
...
s.flashvars=c('QueryString').encode(s.flashvars);



var v=[];
for(var w in s)
if(Object.prototype.hasOwnProperty.call(s,w)&&s[w])
v.push('<param name="'+c('htmlSpecialChars')(w)+'" value="'+
c('htmlSpecialChars')(s[w])+'">');



var x=r.appendChild(j.createElement('span')),
y=
'<object '+(c('UserAgent_DEPRECATED').ie()?
...
try{t=new ActiveXObject(s).
GetVariable('$version').
match(/(\d+),(\d+),(\d+),(\d+)/);
t=Array.prototype.slice.call(t,1);}catch(
...
/** js/pages/like_follow/PagesLikeFollowNotifDispatcher.js */





__d('PagesLikeFollowNotifDispatcher',['Arbiter','ExplicitRegistrationReactDispatcher','PageLikeConstants','PagesLikeFollowNotifActions','SubscriptionsHandler'],(function a(b,c,d,e,f,g){
...
function(m,n){return this.dispatchLike(n.profile_id);}.bind(this)),

c('Arbiter').subscribe
(c('PageLikeConstants').UNLIKED,
function(m,n){return this.dispatchUnlike(n.profile_id);}.bind(this)));}


j.prototype.

dispatchLike=function(k){
this.dispatch
({type:c('PagesLikeFollowNotifActions').LIKE,
data:{pageID:k,likeStatus:true}});};

j.prototype.

dispatchUnlike=function(k){
this.dispatch
({type:c('PagesLikeFollowNotifActions').UNLIKE,
data:{pageID:k,likeStatus:false}});};
...
/** js/pages/like_follow/PagesFollowStore.js */





__d('PagesFollowStore',['FluxReduceStore','PagesLikeFollowNotifActions','PagesLikeFollowNotifDispatcher'],(function a(b,c,d,e,f,g){
...
var m=babelHelpers['extends']({},k);
switch(l.type){
case c('PagesLikeFollowNotifActions').INIT_DATA:
if(l.data.pageID in k)
return k;

m[l.data.pageID]=l.data.followStatus;
return m;
case c('PagesLikeFollowNotifActions').FOLLOW_CHANGED:
m[l.data.pageID]=l.data.followStatus;
return m;}
...
f.exports=new j(c('PagesLikeFollowNotifDispatcher'));}),null);

/** js/video/upload/file/VideoUploadFile.js */





__d('VideoUploadFile',['fileSlice','ImageExtensions','VideoCreatorProductType','VideoUploadFeatureDetector'],(function a(b,c,d,e,f,g){
...
function h(i,j,k,l){'use strict';
this.$VideoUploadFile_fileInput=i;
this.$VideoUploadFile_file=j;
this.$VideoUploadFile_size=k;
this.$VideoUploadFile_extension=l;}
h.
...
fromFile=function(i){'use strict';
var j=h.getExtensionFromFileName(i.name);
return new this(null,i,i.size,j);};
h.
...
fromFileInput=function(i){'use strict';
var j=null,
k=null,
l=h.getExtensionFromFileInput(i);
...
return new this(i,j,k,l);};
h.prototype.




getFileInput=function(){'use strict';
return this.$VideoUploadFile_fileInput;};
h.prototype.
...
return this.$VideoUploadFile_file;};
h.prototype.
...
return this.$VideoUploadFile_size;};
h.prototype.




getExtension=function(){'use strict';
return this.$VideoUploadFile_extension;};
h.prototype.
...
if(this.$VideoUploadFile_extension===c('ImageExtensions').GIF)
return c('VideoCreatorProductType').ANIMATED_GIFS;

return c('VideoCreatorProductType').CORE_VIDEOS;};
h.prototype.
...
getChunk=function(i,j){'use strict';
return this.$VideoUploadFile_file?c('fileSlice').call(this.$VideoUploadFile_file,i,j):null;};
h.

getExtensionFromFileInput=function(i){'use strict';
return this.getExtensionFromFileName(i.value);};
h.

getExtensionFromFileName=function(i){'use strict';
return i.indexOf('.')!=-1?
...
/** shared/persistent_animation_frame/SimpleObjectsPool.js */
...
this.$SimpleObjectsPool_ObjectClass=j;
this.$SimpleObjectsPool_objects=[];}
i.prototype.

get=function(){'use strict';
if(this.$SimpleObjectsPool_objects.length){
return this.$SimpleObjectsPool_objects.pop();}else{

var j=this.$SimpleObjectsPool_ObjectClass;
return new j();}};

i.prototype.

put=function(j){'use strict';
j instanceof this.$SimpleObjectsPool_ObjectClass||h(0,'Invalid object to put');
this.$SimpleObjectsPool_objects.push(j);};



f.exports=i;}),null);

/** shared/persistent_animation_frame/PersistentAnimationFrame.js */
...
function l(){
if(!i)
i=new (c('SimpleObjectsPool'))(m);


return i;}
function m(){'use strict';this.
...
$PersistentAnimationFrame_done=function(){
this.callback();


this.$PersistentAnimationFrame_cleanup();
l().put(this);}.
bind(this);}m.request=function(p){'use strict';if(!p)return 0;return l().get().request(p);};m.cancel=function(p){'use strict';if(p===0)return;var q=j[String(p)];if(q)q.cancel();};m.prototype.request=function(p){'use strict';k&&n();this.callback=p;this.hidden=c('Visibility').isHidden();if(this.hidden){this.intID=setTimeout(this.$PersistentAnimationFrame_done,h);}else this.intID=c('requestAnimationFrame')(this.$PersistentAnimationFrame_done);this.strID=String(this.intID);j[this.strID]=this;return this.intID;};m.prototype.cancel=function(){'use strict';if(this.strID){if(this.hidden){clearTimeout(this.intID);}else c('cancelAnimationFrame')(this.intID);this.$PersistentAnimationFrame_cleanup();l().put(this);}};m.prototype.

$PersistentAnimationFrame_cleanup=function(){'use strict';
delete j[this.strID];
delete this.intID;
delete this.strID;
...
/** shared/persistent_animation_frame/requestPersistentAnimationFrame.js */
...
f.exports=c('PersistentAnimationFrame').request;}),null);

/** shared/dom/ResizeEventHandler.js */
...
if(this.$ResizeEventHandler_isResizing===false){
this.$ResizeEventHandler_isResizing=true;
c('requestPersistentAnimationFrame')(this.$ResizeEventHandler_didResize);}}.

bind(this);this.

$ResizeEventHandler_didResize=function(){
this.$ResizeEventHandler_isResizing=false;
this.$ResizeEventHandler_onResizeCallback();}.
bind(this);this.$ResizeEventHandler_isResizing=false;this.$ResizeEventHandler_onResizeCallback=i;}


f.exports=h;}),null);

/** shared/core_components/ResponsiveBlock/ResponsiveBlock.react.js */
...
l=c('React').createClass({displayName:'ResponsiveBlock',
propTypes:
...
try{this._sensorTarget.onresize=null;}catch(
n){
...
o=
c('React').createElement('div',{key:'sensor',className:"_4u-f"},
...
if(j){
this._sensorTarget=c('ReactDOM').findDOMNode(this.refs.sensorNode);}else 




this._sensorTarget=
c('ReactDOM').findDOMNode(this.refs.sensorNode).contentWindow;
...
this._resizeHandler.handleEvent();}else 


c('requestAnimationFrame')(this._bindResizeEvent);},
...
/** shared/fbjs/functional/everyObject.js */
...
/** shared/fbjs/functional/someObject.js */
...
__d('someObject',[],(function a(b,c,d,e,f,g){
...
/** shared/pages_insights/HubbleContext.js */




__d("HubbleContext",[],(function a(b,c,d,e,f,g){
...
getPageID:function j(){
return h.page&&h.page.id;},


getEventToShow:function j(){
return h.eventToShow;},



setContext:function j(k){
h=k;},


setKey:function j(k,l){
h[k]=l;},
...
/** shared/pages_insights/HubbleLogger.js */




__d('HubbleLogger',['BanzaiLogger','ErrorUtils','HubbleContext','HubbleSurfaces','arrayContains'],(function a(b,c,d,e,f,g){
...
l=
Object.keys(c('HubbleSurfaces')).map(function(n){return c('HubbleSurfaces')[n];}),

m=


{getStatefulFields:function n(){

return {pageid:c('HubbleContext').getPageID(),
platform:j,
prev_section:k,
section:h,
surface:i};},
...
c('BanzaiLogger').log
('HubbleLoggerConfig',babelHelpers['extends']({},

this.getStatefulFields(),
{action:o}));},




logMetric:function n(o,p){
c('BanzaiLogger').log
('HubbleLoggerConfig',babelHelpers['extends']({},
...
logException:function n(o,p){
var q=c('ErrorUtils').normalizeError(p);
c('BanzaiLogger').log
('HubbleLoggerConfig',babelHelpers['extends']({},

this.getStatefulFields(),
{error_message:o,
stack_trace:q.stack.split('\n')}));},
...
setActiveSection:function n(o){
k=h;
h=o;},



setActiveSurface:function n(o){
if(!c('arrayContains')(l,o)){
c('ErrorUtils').reportError('Hubble: Invalid surface value: '+o);
return;}
...
/** shared/request/createChunkedResponseParser.js */
...
q==null||typeof q==='string'||h(0,
'createChunkedResponseParser: Filtered response must be a ?string');}
...
o.parseStreaming=true;
return o;}


f.exports=k;}),null);

/** shared_core/fbjs/crypto/base62.js */





__d('base62',[],(function a(b,c,d,e,f,g){
