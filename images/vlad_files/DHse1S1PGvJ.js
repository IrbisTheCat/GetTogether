if (self.CavalryLogger) { CavalryLogger.start_js(["EvPEI"]); }

/** js/DetectBrokenProxyCache.js */
...
if(k!=i&&k!=null&&
i!='0'){
var l={c:'si_detect_broken_proxy_cache',
m:j+' '+i+' '+k},
m=new (c('URI'))('/common/scribe_endpoint.php').
...
/** www/__virtual__/x/XConsentCookieController.js */



__d("XConsentCookieController",["XController"],(function a(b,c,d,e,f,g){
f.exports=c("XController").create("\/cookie\/consent\/",{pv:{type:"Enum",enumType:0}});}),

null);

/** js/modules/DeferredCookie.js */
...
if(o){
c('Cookie').setWithoutChecksIfFirstPartyContext
(k,
l,
m,
n,
...
c('Cookie').setWithoutChecks(k,l,m,n,q);
...
if(p)
this.addDefaultInteractionListener();},
...
if(l.firstPartyOnly){
c('Cookie').setWithoutChecksIfFirstPartyContext
(l.name,l.value,l.nMilliSecs,l.path,l.secure);}else 


c('Cookie').setWithoutChecks
(l.name,l.value,l.nMilliSecs,l.path,l.secure);});
...
var k=c('XConsentCookieController').getURIBuilder().
setEnum('pv',this.getNoticePolicyVersion()).
getURI();
new (c('AsyncRequest'))().
setURI(k).
send();}
...
try{var l=document.getElementById('cpn-pv-link');
if(!l)
return '1';

return l.getAttribute('data-pv');}catch(
k){
return '1';}},
...
window.removeEventListener('click',this.defaultHandler,true);}else
if(document.detachEvent)
document.detachEvent('onclick',this.defaultHandler);
...
window.addEventListener('click',this.defaultHandler,true);}else
if(document.attachEvent)

document.attachEvent('onclick',this.defaultHandler);}},




registerCallbackOnCookieFlush:function j
(k){
...
if(c('Env').no_cookies||c('Env').defer_cookies)
return false;
...
/** shared/facebook/isOculusDotComURI.js */
...
if(c('isOculusDotComURI')(c('URI').getRequestURI())){


o='/common/referer_frame.php';}else
...
if(!c('DeferredCookie').canEmbedThirdPartyPixel()){
c('JSLog').error
('Attempting to load a TrackingPixel (%s) while cookies are deferred. '+
'This is not allowed because tracking pixels sometimes set cookies.',
j);
...
/** js/help/lite/HelpLiteFlyoutBootloader.js */
...
{loadFlyout:function l(){return c('regeneratorRuntime').async(function m(n){while(1)switch(n.prev=n.next){case 0:
k.loadFlyoutWithHelpType(null);case 1:case 'end':return n.stop();}},null,this);},
...
/** js/modules/AccessibilityLogger.js */
...
new (c('AsyncSignal'))
('/ajax/accessibilitylogging',
{eventName:k,times_pressed:l[j]}).
send();
l[j+'-ts']=m;
...
if(this.method=='POST')
c('Nectar').addModuleData(this.data,i);}});}),
...
if(l.id.substr(0,8)=='pagelet_')
return l.id.substr(8);

if(l.id.substr(0,8)=='box_app_')
...
var k=
j.getAttribute&&
(j.getAttribute('ajaxify')||
j.getAttribute('data-endpoint'))||
...
return j&&(h.get_href(j)||
j.getAttribute&&c('DataAttributeUtils').getDataFt(j));}};
...
if(!!n)
s=c('ClickRefUtils').get_href(n);



var u=c('collectDataAttributes')
(!!event?event.target||event.srcElement:n,
['ft','gt']);
...
m._context,
r||'-',
c('ClickRefUtils').get_intern_ref(n),
p,
b.URI?
b.URI.getRequestURI(true,true).getUnqualifiedURI().toString():
location.pathname+location.search+location.hash,
u].
concat(q).concat(c('pageID')).concat(c('ScriptPath').getScriptPath());
return v;}
...
w+=String.fromCharCode(1^v.charCodeAt(x));
...
var m=0,
n=function o(){
new (c('AsyncSignal'))('/si/kappa/',{Ko:"a"}).send();
if(++m<j)
c('setTimeoutAcrossTransitions')(o,k*1000);};
...
var j=i.stop||h._(["Stop!","10d10d3067ca4995442b2e872f843649"]),




k=i.text||h._(["This is a browser feature intended for developers. If someone told you to copy-paste something here to enable a Facebook feature or \"hack\" someone's account, it is a scam and will give them access to your Facebook account.","a0cf4ddd4dbd7b60ff62e3c1622fc2aa"]),
...
l=i.more||h._(["See {url} for more information.","58558a973c66b1fb35b24401141d1a6a"],

[h.param('url','https://www.facebook.com/selfxss')]);
...
[[j,i.c1||m+'font-size:50px; font-weight:bold; '+
