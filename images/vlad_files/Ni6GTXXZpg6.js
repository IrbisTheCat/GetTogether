...
/** shared/moat_nht/MoatNHTSignalTypes.js */





__d("MoatNHTSignalTypes",[],(function a(b,c,d,e,f,g){
...
/** shared/moat_nht/MoatNHTDetection.js */
...
__d('MoatNHTDetection',['Banzai','MoatNHTFacebookSpecificSignals','MoatNHTSignals','URI'],(function a(b,c,d,e,f,g){
...
var h=
(c('MoatNHTSignals').getSignals()||[]).
concat(c('MoatNHTFacebookSpecificSignals').getSignals()||[]),
...
{evaluateAndLogSignals:function l(m){
var n=j(),
...
c('Banzai').post('xtrackable:moat_nht',o);
