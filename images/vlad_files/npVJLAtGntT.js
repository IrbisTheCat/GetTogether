if (self.CavalryLogger) { CavalryLogger.start_js(["NI7te"]); }

/** __static_js_modules__/messagingthreadtype.js */




__d("MessagingThreadType",[],(function a(b,c,d,e,f,g){

f.exports={ONE_TO_ONE:1,GROUP:2,ROOM:3,MONTAGE:4,MARKETPLACE:5};}),

null);

/** __static_js_modules__/p2ppaymentloggerevent.js */
...
handleLinkClick=function(r){
if(this.props.disabled){
r.preventDefault();}else
...
this.props,n=m.className,o=m.color,p=m.customColor,q=m.disabled,r=m.label,s=m.type,t=m.use,u=babelHelpers.objectWithoutProperties(m,['className','color','customColor','disabled','label','type','use']),
...
({className:c('joinClasses')("_3quh"+(' '+"_30yy")+
...
c('React').createElement(c('Link.react'),w,r):
c('React').createElement('span',
{className:c('joinClasses')
("_30vt",
this.props.wrapperClassName)},

c('React').createElement('button',w,
r)));};



l.propTypes={color:k.string,customColor:k.bool.isRequired,label:k.node,type:k.oneOf(['primary','secondary']).isRequired,use:k.oneOf(['default','danger']).isRequired,wrapperClassName:k.string};l.defaultProps={use:'default',customColor:false};


f.exports=l;}),null);

/** js/mercury/clients/messenger/components/core/MessengerDialog.react.js */
...
j=c('React').createClass({displayName:'MessengerDialog',
propTypes:
...
return {repositionOnUpdate:false,
shown:true,
type:'alert',
width:400};},
...
(this.props.type==='alert'?' '+"_2c9g":'')+
(this.props.type==='default'?' '+"_2c9i":'')},
...
/** js/mercury/clients/messenger/components/core/MessengerDialogBody.react.js */
...
/** js/mercury/clients/messenger/components/core/MessengerDialogFooter.react.js */
...
function l(){i.apply(this,arguments);}l.propTypes={leftContent:k.object};


f.exports=l;}),null);

/** js/mercury/clients/messenger/components/core/MessengerDialogHeader.react.js */
...
/** js/mercury/clients/shared/components/attachments/share/MercuryShareAttachmentRenderLocations.js */
...
isPreview:function i(j){
return j===h.CHAT_PREVIEW;}};



f.exports=h;}),null);

/** js/p2p/actions/P2PActions.js */
...
__d('P2PActions',['ChatOpenTab','ChatOpenTabEventLogger','FantaTabActions','P2PActionConstants','P2PDispatcher','MercuryShareAttachmentRenderLocations','ifRequired'],(function a(b,c,d,e,f,g){
...
var h=
{updateCreditCards:function i(j){
...
updateCreditCardsError:function i(){
c('P2PDispatcher').dispatch
({type:c('P2PActionConstants').CREDIT_CARDS_UPDATED_ERROR});},



updatePaymentMethods:function i(j){
c('P2PDispatcher').dispatch
...
updatePaymentMethodsError:function i(j){
c('P2PDispatcher').dispatch
...
addCreditCardError:function i(j){
c('P2PDispatcher').dispatch
...
addCreditCardErrorCleared:function i(){
c('P2PDispatcher').dispatch
({type:c('P2PActionConstants').CREDIT_CARD_ADDED_ERROR_CLEARED});},



updatePresetCreditCard:function i(j){
c('P2PDispatcher').dispatch
...
updatePresetCreditCardError:function i(j){
c('P2PDispatcher').dispatch
...
updateCreditCardError:function i(j){
c('P2PDispatcher').dispatch
...
deleteCreditCardError:function i(j){
c('P2PDispatcher').dispatch
...
verifyCreditCardError:function i(j){
c('P2PDispatcher').dispatch
...
updateTransfersError:function i(j){
c('P2PDispatcher').dispatch
...
updateNUXTransfers:function i(j){
c('P2PDispatcher').dispatch
...
transferAddedError:function i(j){
c('P2PDispatcher').dispatch
...
transferUpdatedError:function i(j){
c('P2PDispatcher').dispatch
...
transferAccepted:function i(){
c('P2PDispatcher').dispatch
({type:c('P2PActionConstants').TRANSFER_ACCEPTED});},



transferDeclined:function i(j){
c('P2PDispatcher').dispatch
...
chatSendViewOpened:function i(j){
function k(){
c('P2PDispatcher').dispatch
...
if(j.referrer===c('MercuryShareAttachmentRenderLocations').WEB_INBOX){
k();}else
if(c('ChatOpenTab').canOpenTab()){

c('FantaTabActions').openTab(j.threadID);
c('ChatOpenTabEventLogger').log('p2pAction',j.threadID);
k();}else{

c('ifRequired')('MessengerActions',
function(l){return l.selectThread(j.threadID);});

k();}},



chatSendViewClosed:function i(j){
c('P2PDispatcher').dispatch
...
binNumberValidated:function i(j){
c('P2PDispatcher').dispatch
...
binNumberValidatedError:function i(j){
c('P2PDispatcher').dispatch
...
friendsListUpdated:function i(j){
c('P2PDispatcher').dispatch
...
userEligibilityUpdated:function i(j){
c('P2PDispatcher').dispatch
...
bannerStatesUpdated:function i(j){
c('P2PDispatcher').dispatch
...
moneypennyTransferCreated:function i(j){
c('P2PDispatcher').dispatch
...
moneypennyTransferCreatedError:function i(j){
c('P2PDispatcher').dispatch
...
addPlatformContext:function i(j){
c('P2PDispatcher').dispatch
...
addPlatformContextError:function i(j){
c('P2PDispatcher').dispatch
...
clearPlatformContextSaveErrors:function i(j){
c('P2PDispatcher').dispatch
...
platformContextBannerDismissed:function i(j){
c('P2PDispatcher').dispatch
...
platformContextProductItemSold:function i(j){
c('P2PDispatcher').dispatch
...
platformContextChanged:function i(j){
c('P2PDispatcher').dispatch
...
extensiveTransferDetailsLoaded:function i(j){
c('P2PDispatcher').dispatch
...
addressSaving:function i(){
c('P2PDispatcher').dispatch
({type:c('P2PActionConstants').ADDRESS_SAVING});},



addAddress:function i(j){
c('P2PDispatcher').dispatch
...
checkoutShippingOptionSelected:function i(j){
c('P2PDispatcher').dispatch
...
checkoutAddressSelected:function i(j){
c('P2PDispatcher').dispatch
...
checkoutCreditCardSelected:function i(j){
c('P2PDispatcher').dispatch
...
checkoutAddressFormToggled:function i(j){
c('P2PDispatcher').dispatch
...
checkoutCreditCardFormToggled:function i(j){
c('P2PDispatcher').dispatch
...
checkoutAddressEditOptionsToggled:function i(j){
c('P2PDispatcher').dispatch
...
checkoutCreditCardEditOptionsToggled:function i(j){
c('P2PDispatcher').dispatch
...
checkoutPaymentMethodEditOptionsToggled:function i(j){
c('P2PDispatcher').dispatch
...
checkoutPaymentMethodSelected:function i(j){
c('P2PDispatcher').dispatch
...
checkoutPaymentMethodConfigured:function i(j){
c('P2PDispatcher').dispatch
...
checkoutPaymentMethodConfirmed:function i(j){
c('P2PDispatcher').dispatch
...
checkoutCreditCardFormValidated:function i(j,k){
c('P2PDispatcher').dispatch
...
checkoutAddressFormValidated:function i(j,k){
c('P2PDispatcher').dispatch
...
checkoutEditCompleted:function i(){
c('P2PDispatcher').dispatch
({type:c('P2PActionConstants').CHECKOUT_EDIT_COMPLETED});},



checkoutProcessing:function i(j){
c('P2PDispatcher').dispatch
...
checkoutBuyerProfileUpdated:function i(j){
c('P2PDispatcher').dispatch
...
checkoutManualPaymentReceiptUpdated:function i(j){
c('P2PDispatcher').dispatch
...
paymentRequestCreatedError:function i(j){
c('P2PDispatcher').dispatch
...
paymentRequestUpdated:function i(j){
c('P2PDispatcher').dispatch
...
paymentRequestDeclineInitiated:function i(){
c('P2PDispatcher').dispatch
({type:c('P2PActionConstants').PAYMENT_REQUEST_DECLINE_INITIATED});},



paymentRequestDeclined:function i(j){
c('P2PDispatcher').dispatch
...
paymentRequestDeclineError:function i(j){
c('P2PDispatcher').dispatch
...
paymentRequestCancelInitiated:function i(){
c('P2PDispatcher').dispatch
({type:c('P2PActionConstants').PAYMENT_REQUEST_CANCEL_INITIATED});},



paymentRequestCanceled:function i(j){
c('P2PDispatcher').dispatch
...
paymentRequestCancelError:function i(j){
c('P2PDispatcher').dispatch
...
paymentRequestsFetched:function i(j){
c('P2PDispatcher').dispatch
...
/** js/p2p/components/common/P2PLoadingMask.react.js */
...
return (c('React').createElement('div',{className:"_3de"},
c('React').createElement(c('XUISpinner.react'),{background:'dark',size:'large',
className:"_3df"}),

c('React').createElement('div',{className:"_3dg"})));};


function l(){i.apply(this,arguments);}l.propTypes={visible:k.bool};l.defaultProps={visible:false};


f.exports=l;}),null);

/** js/p2p/logging/P2PLogger.js */
...
c('BanzaiLogger').log(h,l);}};



f.exports=i;}),null);

/** www/__virtual__/x/XWebGraphQLMutationController.js */



__d("XWebGraphQLMutationController",["XController"],(function a(b,c,d,e,f,g){
f.exports=c("XController").create("\/webgraphql\/mutation\/",{query_id:{type:"FBID"},variables:{type:"String"},doc_id:{type:"FBID"}});}),

null);

/** shared/webgraphql/WebGraphQLMutationHelper.js */





__d('WebGraphQLMutationHelper',['CurrentUser','XWebGraphQLMutationController','base62'],(function a(b,c,d,e,f,g){
...
var k=j.controller,l=k===undefined?c('XWebGraphQLMutationController'):k,m=j.docID;

return {__getDocID:function n(){return m;},
...
({client_mutation_id:c('base62')(h++),
actor_id:c('CurrentUser').getID()},
o);


p.setString('variables',JSON.stringify({data:q}));
...
/** www/__virtual__/webgraphql/FBPaymentsInvoiceCreationMutationWebGraphQLMutation.js */
...
__d("FBPaymentsInvoiceCreationMutationWebGraphQLMutation",["WebGraphQLMutationHelper"],(function a(b,c,d,e,f,g){
...
({docID:"1241088092643730",
queryID:"1518588384828580"});}),null);
