...
/** shared/emoji/MessengerSupportedEmoji.js */
...
__d('MessengerSupportedEmoji',['EmojiRenderer','EmoticonEmojiList','Utf16'],(function a(b,c,d,e,f,g){
...
j=function m(n){
var o=c('EmojiRenderer').parse(n,1);
if(o.length!==1)
return null;
...
l=function m(n){
var o=c('EmoticonEmojiList').emote2emojis[n];
return h[o]?o:null;};
