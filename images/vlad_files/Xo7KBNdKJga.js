if (self.CavalryLogger) { CavalryLogger.start_js(["5JKdv"]); }

/** js/components/core/UI/CloseButton/CloseButton.react.js */





__d('CloseButton.react',['cx','fbt','React','Image.react','joinClasses'],(function a(b,c,d,e,f,g,h,i){var j,k;j=babelHelpers.inherits
...
(p?' '+"uiCloseButtonSmall":'')+
(q?' '+"uiCloseButtonHuge":'')+
(p&&r?' '+"uiCloseButtonSmallDark":'')+
(p&&s?' '+"uiCloseButtonSmallInverted":'')+
(!p&&r?' '+"uiCloseButtonDark":'')+
(!p&&s?' '+"uiCloseButtonInverted":''),


w=i._(["Close","916afe4ec70dab1eff790d4e4b87cb09"]),




x=Object.assign({},this.props);
delete x.size;
delete x.appearance;
delete x.ajaxify;
delete x.tooltip;
...
/** shared/hashtag/getHashtagRegexString.js */
...
/** shared/hashtag/getHashtagRegex.js */
